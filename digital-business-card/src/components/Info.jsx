...
export default function Info() {
    return (
        <div className="info">
            <img className="info--profile" src="/images/profile.jpg" alt="laura proflie"/>
            ...
            <div className="info--btn-ctn">
                <button className="info--btn email">
                    <img className="info--contact" src="/images/mail.png" alt="email"/>
                    <a href="#">Email</a>
                </button>
                <button className="info--btn linkedin">
                    <img className="info--contact" src="/images/linkedin.png" alt="linkedin"/>
                    <a href="#">LinkedIn</a>
                </button>
            </div>
        </div>
